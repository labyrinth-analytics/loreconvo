...
Once loaded, Claude has access to all 16 LoreConvo MCP tools automatically. Ask Claude to "save this session" or "recall what we discussed about X" and it will use the tools on its own.
...
LoreConvo provides 16 MCP tools that Claude calls automatically during sessions:
