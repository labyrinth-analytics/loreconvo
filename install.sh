...
echo "    claude mcp add --scope user loreconvo -- $VENV_DIR/bin/python $SCRIPT_DIR/src/server.py"
echo ""
echo "  Add --env=LORECONVO_PRO=<key> before 'loreconvo' if you have a Pro license."
echo ""
